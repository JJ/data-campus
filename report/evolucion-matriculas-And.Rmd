...
```{r total, echo=FALSE}
ggplot()+geom_line(data=matriculas.year,aes(x=curso,y=total,group=1,color="Total"))+geom_line(data=matriculas.year,aes(x=curso,y=mujeres,group=1,color="Mujeres")) +theme_tufte() + theme(axis.text.x = element_text(angle = 90, hjust = 1))
```   
